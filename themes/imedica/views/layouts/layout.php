...
<html xmlns="http://www.w3.org/1999/xhtml" class="ihome">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->baseUrl;?>/rs-plugin/css/settings.min.css" media="screen" />
        <!--[if IE 9]>
            <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->baseUrl;?>/css/ie9.css" />
        <![endif]-->    
        <link rel="icon" type="image/png" href="<?php echo Yii::app()->baseUrl;?>/images/fevicon.png">
    ...
    <body>
        ...
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/js/jquery-ui-1.10.3.custom.min.js"></script>  
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/bootstrap-new/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/js/jquery.scrollUp.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/js/jquery.sticky.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/js/wow.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/js/jquery.flexisel.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/js/jquery.imedica.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/js/custom-imedicajs.min.js"></script>
