...
<html xmlns="http://www.w3.org/1999/xhtml" class="ihome">
    <head>
        ...
        <link href='http://fonts.googleapis.com/css?family=Noto+Sans:400,700,400italic' rel='stylesheet' type='text/css'>
            ...
            <link href="<?php echo Yii::app()->baseUrl;?>/imedica/css/jquery-ui-1.10.3.custom.css" rel="stylesheet" />
        <link href="<?php echo Yii::app()->baseUrl;?>/imedica/css/animate.css" rel="stylesheet" />
        <link href="<?php echo Yii::app()->baseUrl;?>/imedica/css/font-awesome.min.css" rel="stylesheet" />
        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->baseUrl;?>/imedica/css/blue.css" id="style-switch" />
        <!-- REVOLUTION BANNER CSS SETTINGS -->
        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->baseUrl;?>/imedica/rs-plugin/css/settings.min.css" media="screen" />
        <!--[if IE 9]>
            <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->baseUrl;?>/imedica/css/ie9.css" />
        <![endif]-->    
        <link rel="icon" type="image/png" href="<?php echo Yii::app()->baseUrl;?>/imedica/images/fevicon.png">

        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->baseUrl;?>/imedica/css/slides.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->baseUrl;?>/imedica/css/inline.min.css" />


    </head>
    <body>
        <div id="loader-overlay"><img src="<?php echo Yii::app()->baseUrl;?>/imedica/images/loader.gif" alt="Loading" /></div>
...
<!--        <div>
        ...
        <div class="complete-footer">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <p class="col-xs-12 col-md-5 no-pad">Copyright 2016 OsteoEgypt | All Rights Reserved </p>
        ...
        <!--JS Inclution-->
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/imedica/js/jquery.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/imedica/js/jquery-ui-1.10.3.custom.min.js"></script>  
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/imedica/bootstrap-new/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/imedica/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/imedica/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/imedica/js/jquery.scrollUp.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/imedica/js/jquery.sticky.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/imedica/js/wow.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/imedica/js/jquery.flexisel.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/imedica/js/jquery.imedica.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->baseUrl;?>/imedica/js/custom-imedicajs.min.js"></script>
